...
public class AuxVariables {
    ...
    //////////Auto Messenger is running////////////////////////
    public static volatile boolean autoMessengerIsRunning = false;

    public void setAutoMessengerRunningTo(boolean b){
        autoMessengerIsRunning = b;
    }

    public boolean isAutoMessengerRunning() {
        return autoMessengerIsRunning;
    }
